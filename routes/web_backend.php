...
Route::group(['middleware' => ['backend.login.check']], function () {
    ...
    Route::group(['middleware' => 'backend.permission.check'], function () {
        ...
        //标签
        Route::get('/tag', 'TagController@index')->name('backend.tag.index');
        Route::get('/tag/create', 'TagController@create')->name('backend.tag.create');
        Route::post('/tag/create', 'TagController@store');
        Route::get('/tag/{id}/edit', 'TagController@edit')->name('backend.tag.edit');
        Route::put('/tag/{id}/edit', 'TagController@update');
        ...
        Route::get('/administrator_menu/createmenu', 'AdministratorMenuController@createmenu')->name('backend.administrator_menu.createmenu');
